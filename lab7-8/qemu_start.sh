...
JENKINS_BUILD_URL="https://jenkins.openbmc.org/job/ci-openbmc/ \
lastSuccessfulBuild/distro=ubuntu,label=docker-builder, \
target=romulus/artifact/openbmc/build/tmp/deploy/images/romulus/*zip*/romulus.zip"
